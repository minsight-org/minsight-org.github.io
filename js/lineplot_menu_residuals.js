...
ctx.lineWidth="1";
ctx.moveTo(50.5,50);
ctx.lineTo(50.5,h-50);
ctx.lineTo(w-50.5,h-50);
ctx.stroke();
...
//Moessbauer function
		...
		var ratio1 = document.getElementById("ratio_1").value;
		var r1 =ratio1/s;
		var per1 = document.getElementById("slider1").value*100;
...
function Voigt_1(x) {
    ...
    var w = document.getElementById("vbflinewidth_1").value;
    var cens = document.getElementById("vbfcenshift_1").value;
    var eps = document.getElementById("vbfqshift_1").value;
    var bhf = document.getElementById("vbfhyperfinefield_1").value;
    var sigma = document.getElementById("vbfsigma_1").value;
    var ratio1 = document.getElementById("vbfratio_1").value;
    ...
    /*var x01 = (0 - (bhf/32.95 * 10.657/2)*(Z+3) + cens/1 + eps/2); //0-0+CS+QS = CS + QS
    var x02 = (0 - (bhf/32.95 * 6.167/2)*(Z+1) + cens/1 - eps/2);  //0-0+CS-QS = CS - QS
    var x03 = (0 - (bhf/32.95 * 1.677/2)*(Z-1) + cens/1 - eps/2);  //0-0+CS-QS = CS - QS
    var x04 = (0 + (bhf/32.95 * 1.677/2)*(Z-1) + cens/1 - eps/2);  //0+0+CS-QS = CS - QS
    var x05 = (0 + (bhf/32.95 * 6.167/2)*(Z+1) + cens/1 - eps/2);  //0+0+CS-QS = CS - QS
    var x06 = (0 + (bhf/32.95 * 10.657/2)*(Z+3) + cens/1 + eps/2); //0+0+CS+QS = CS + QS*/

    //var phi = (x-freq)/(sigma*Math.sqrt(2));
    var phi1 = (x-x01)/(sigma*Math.sqrt(2));
    var phi2 = (x-x02)/(sigma*Math.sqrt(2));
    var phi3 = (x-x03)/(sigma*Math.sqrt(2));
    var phi4 = (x-x04)/(sigma*Math.sqrt(2));
    var phi5 = (x-x05)/(sigma*Math.sqrt(2));
    var phi6 = (x-x06)/(sigma*Math.sqrt(2));

    var y = gamma/(sigma*Math.sqrt(2));

    //Numerical coefficients
    var ak1 = -1.2150, ak2 = -1.3509, ak3 = -1.2150, ak4 = -1.3509;
    var bk1 = 1.2359, bk2 = 0.3786, bk3 = -1.2359, bk4 = -0.3786;
    var gk1 = -0.3085, gk2 = 0.5906, gk3 = -0.3085, gk4 = 0.5906;
    var dk1 = 0.0210, dk2 = -1.1858, dk3 = -0.0210, dk4 = 1.1858;

    var k11 = (gk1*(y - ak1) + dk1*((phi1)-bk1))/((y-ak1)*(y-ak1)+((phi1)-bk1)*((phi1)-bk1));
    var k21 = (gk2*(y - ak2) + dk2*((phi1)-bk2))/((y-ak2)*(y-ak2)+((phi1)-bk2)*((phi1)-bk2));
    var k31 = (gk3*(y - ak3) + dk3*((phi1)-bk3))/((y-ak3)*(y-ak3)+((phi1)-bk3)*((phi1)-bk3));
    var k41 = (gk4*(y - ak4) + dk4*((phi1)-bk4))/((y-ak4)*(y-ak4)+((phi1)-bk4)*((phi1)-bk4));
    var ksum1 = k11 + k21 + k31 + k41;
    
    var k12 = (gk1*(y - ak1) + dk1*((phi2)-bk1))/((y-ak1)*(y-ak1)+((phi2)-bk1)*((phi2)-bk1));
    var k22 = (gk2*(y - ak2) + dk2*((phi2)-bk2))/((y-ak2)*(y-ak2)+((phi2)-bk2)*((phi2)-bk2));
    var k32 = (gk3*(y - ak3) + dk3*((phi2)-bk3))/((y-ak3)*(y-ak3)+((phi2)-bk3)*((phi2)-bk3));
    var k42 = (gk4*(y - ak4) + dk4*((phi2)-bk4))/((y-ak4)*(y-ak4)+((phi2)-bk4)*((phi2)-bk4));
    var ksum2 = k12 + k22 + k32 + k42;

    var k13 = (gk1*(y - ak1) + dk1*((phi3)-bk1))/((y-ak1)*(y-ak1)+((phi3)-bk1)*((phi3)-bk1));
    var k23 = (gk2*(y - ak2) + dk2*((phi3)-bk2))/((y-ak2)*(y-ak2)+((phi3)-bk2)*((phi3)-bk2));
    var k33 = (gk3*(y - ak3) + dk3*((phi3)-bk3))/((y-ak3)*(y-ak3)+((phi3)-bk3)*((phi3)-bk3));
    var k43 = (gk4*(y - ak4) + dk4*((phi3)-bk4))/((y-ak4)*(y-ak4)+((phi3)-bk4)*((phi3)-bk4));
    var ksum3 = k13 + k23 + k33 + k43;

    var k14 = (gk1*(y - ak1) + dk1*((phi4)-bk1))/((y-ak1)*(y-ak1)+((phi4)-bk1)*((phi4)-bk1));
    var k24 = (gk2*(y - ak2) + dk2*((phi4)-bk2))/((y-ak2)*(y-ak2)+((phi4)-bk2)*((phi4)-bk2));
    var k34 = (gk3*(y - ak3) + dk3*((phi4)-bk3))/((y-ak3)*(y-ak3)+((phi4)-bk3)*((phi4)-bk3));
    var k44 = (gk4*(y - ak4) + dk4*((phi4)-bk4))/((y-ak4)*(y-ak4)+((phi4)-bk4)*((phi4)-bk4));
    var ksum4 = k14 + k24 + k34 + k44;

    var k15 = (gk1*(y - ak1) + dk1*((phi5)-bk1))/((y-ak1)*(y-ak1)+((phi5)-bk1)*((phi5)-bk1));
    var k25 = (gk2*(y - ak2) + dk2*((phi5)-bk2))/((y-ak2)*(y-ak2)+((phi5)-bk2)*((phi5)-bk2));
    var k35 = (gk3*(y - ak3) + dk3*((phi5)-bk3))/((y-ak3)*(y-ak3)+((phi5)-bk3)*((phi5)-bk3));
    var k45 = (gk4*(y - ak4) + dk4*((phi5)-bk4))/((y-ak4)*(y-ak4)+((phi5)-bk4)*((phi5)-bk4));
    var ksum5 = k15 + k25 + k35 + k45;

    var k16 = (gk1*(y - ak1) + dk1*((phi6)-bk1))/((y-ak1)*(y-ak1)+((phi6)-bk1)*((phi6)-bk1));
    var k26 = (gk2*(y - ak2) + dk2*((phi6)-bk2))/((y-ak2)*(y-ak2)+((phi6)-bk2)*((phi6)-bk2));
    var k36 = (gk3*(y - ak3) + dk3*((phi6)-bk3))/((y-ak3)*(y-ak3)+((phi6)-bk3)*((phi6)-bk3));
    var k46 = (gk4*(y - ak4) + dk4*((phi6)-bk4))/((y-ak4)*(y-ak4)+((phi6)-bk4)*((phi6)-bk4));
    var ksum6 = k16 + k26 + k36 + k46;


    /*var k11 = (gk1*(y - ak1) + dk1*((phi - x01)-bk1))/((y-ak1)*(y-ak1)+((phi - x01)-bk1)*((phi - x01)-bk1));
    var k21 = (gk2*(y - ak2) + dk2*((phi - x01)-bk2))/((y-ak2)*(y-ak2)+((phi - x01)-bk2)*((phi - x01)-bk2));
    var k31 = (gk3*(y - ak3) + dk3*((phi - x01)-bk3))/((y-ak3)*(y-ak3)+((phi - x01)-bk3)*((phi - x01)-bk3));
    var k41 = (gk4*(y - ak4) + dk4*((phi - x01)-bk4))/((y-ak4)*(y-ak4)+((phi - x01)-bk4)*((phi - x01)-bk4));
    var ksum1 = k11 + k21 + k31 + k41;

    var k12 = (gk1*(y - ak1) + dk1*((phi - x02)-bk1))/((y-ak1)*(y-ak1)+((phi - x02)-bk1)*((phi - x02)-bk1));
    var k22 = (gk2*(y - ak2) + dk2*((phi - x02)-bk2))/((y-ak2)*(y-ak2)+((phi - x02)-bk2)*((phi - x02)-bk2));
    var k32 = (gk3*(y - ak3) + dk3*((phi - x02)-bk3))/((y-ak3)*(y-ak3)+((phi - x02)-bk3)*((phi - x02)-bk3));
    var k42 = (gk4*(y - ak4) + dk4*((phi - x02)-bk4))/((y-ak4)*(y-ak4)+((phi - x02)-bk4)*((phi - x02)-bk4));
    var ksum2 = k12 + k22 + k32 + k42;

    var k13 = (gk1*(y - ak1) + dk1*((phi - x03)-bk1))/((y-ak1)*(y-ak1)+((phi - x03)-bk1)*((phi - x03)-bk1));
    var k23 = (gk2*(y - ak2) + dk2*((phi - x03)-bk2))/((y-ak2)*(y-ak2)+((phi - x03)-bk2)*((phi - x03)-bk2));
    var k33 = (gk3*(y - ak3) + dk3*((phi - x03)-bk3))/((y-ak3)*(y-ak3)+((phi - x03)-bk3)*((phi - x03)-bk3));
    var k43 = (gk4*(y - ak4) + dk4*((phi - x03)-bk4))/((y-ak4)*(y-ak4)+((phi - x03)-bk4)*((phi - x03)-bk4));
    var ksum3 = k13 + k23 + k33 + k43;

    var k14 = (gk1*(y - ak1) + dk1*((phi - x04)-bk1))/((y-ak1)*(y-ak1)+((phi - x04)-bk1)*((phi - x04)-bk1));
    var k24 = (gk2*(y - ak2) + dk2*((phi - x04)-bk2))/((y-ak2)*(y-ak2)+((phi - x04)-bk2)*((phi - x04)-bk2));
    var k34 = (gk3*(y - ak3) + dk3*((phi - x04)-bk3))/((y-ak3)*(y-ak3)+((phi - x04)-bk3)*((phi - x04)-bk3));
    var k44 = (gk4*(y - ak4) + dk4*((phi - x04)-bk4))/((y-ak4)*(y-ak4)+((phi - x04)-bk4)*((phi - x04)-bk4));
    var ksum4 = k14 + k24 + k34 + k44;

    var k15 = (gk1*(y - ak1) + dk1*((phi - x05)-bk1))/((y-ak1)*(y-ak1)+((phi - x05)-bk1)*((phi - x05)-bk1));
    var k25 = (gk2*(y - ak2) + dk2*((phi - x05)-bk2))/((y-ak2)*(y-ak2)+((phi - x05)-bk2)*((phi - x05)-bk2));
    var k35 = (gk3*(y - ak3) + dk3*((phi - x05)-bk3))/((y-ak3)*(y-ak3)+((phi - x05)-bk3)*((phi - x05)-bk3));
    var k45 = (gk4*(y - ak4) + dk4*((phi - x05)-bk4))/((y-ak4)*(y-ak4)+((phi - x05)-bk4)*((phi - x05)-bk4));
    var ksum5 = k15 + k25 + k35 + k45;

    var k16 = (gk1*(y - ak1) + dk1*((phi - x06)-bk1))/((y-ak1)*(y-ak1)+((phi - x06)-bk1)*((phi - x06)-bk1));
    var k26 = (gk2*(y - ak2) + dk2*((phi - x06)-bk2))/((y-ak2)*(y-ak2)+((phi - x06)-bk2)*((phi - x06)-bk2));
    var k36 = (gk3*(y - ak3) + dk3*((phi - x06)-bk3))/((y-ak3)*(y-ak3)+((phi - x06)-bk3)*((phi - x06)-bk3));
    var k46 = (gk4*(y - ak4) + dk4*((phi - x06)-bk4))/((y-ak4)*(y-ak4)+((phi - x06)-bk4)*((phi - x06)-bk4));
    var ksum6 = k16 + k26 + k36 + k46;*/

    var vphi1 = I1*(Math.PI*h*gamma)/(Math.sqrt(2*Math.PI)*sigma)*ksum1;
    var vphi2 = I2*(Math.PI*h*gamma)/(Math.sqrt(2*Math.PI)*sigma)*ksum2;
    var vphi3 = I3*(Math.PI*h*gamma)/(Math.sqrt(2*Math.PI)*sigma)*ksum3;
    var vphi4 = I3*(Math.PI*h*gamma)/(Math.sqrt(2*Math.PI)*sigma)*ksum4;
    var vphi5 = I2*(Math.PI*h*gamma)/(Math.sqrt(2*Math.PI)*sigma)*ksum5;
    var vphi6 = I1*(Math.PI*h*gamma)/(Math.sqrt(2*Math.PI)*sigma)*ksum6;

    var vphisum_1 = vphi1+vphi2+vphi3+vphi4+vphi5+vphi6;
    //var vphisum = vphi1;
...
function Voigt_2(x) {
    ...
    var w = document.getElementById("vbflinewidth_2").value;
    var cens = document.getElementById("vbfcenshift_2").value;
    var eps = document.getElementById("vbfqshift_2").value;
    var bhf = document.getElementById("vbfhyperfinefield_2").value;
    var sigma = document.getElementById("vbfsigma_2").value;
    var ratio1 = document.getElementById("vbfratio_2").value;
    ...
    var vphisum_2 = vphi1+vphi2+vphi3+vphi4+vphi5+vphi6;
    //var vphisum = vphi1;
	...
	function draw_sum() {
      ...
      var xscale=width/xxrange; //This value dictates the width of the fit. Needs to be calibrated

      if (null==canvas || !canvas.getContext) return;

			var axes={}, ctx=canvas.getContext("2d");
			axes.x0 = canvas.width;    // x0 pixels from left to x=0
			axes.y0 = 0.15*canvas.height; // y0 pixels from top to y=0
			axes.scale = xscale;       // 40 pixels from x=0 to x=1
			axes.doNegativeX = true;
...
function checkboxes() {
  ...
  if (checkBox1.checked == true && checkBox2.checked == false && checkBox3.checked == false){
    ...
    ctx.clearRect(0,0,canvas.width, canvas.height);
    newGraphspectra();newGraph();mossline();majoraxes();       
  }  
    ...
    ctx.clearRect(0,0,canvas.width, canvas.height);
    mossline();newGraphspectra();majoraxes();       
  } 
...
function processlistData() {
    ...
    var allTextSample = csv.split(/\r\n|\n/);  //Used to include the name of the sample
    allTextSample.splice(2,2000);              //Removes all lines after the 3rd line
    allTextSample.pop(10);                     //clears up any remaining lines
    document.getElementById('samplename').value = allTextSample


    var allTextInfo = csv.split(/\r\n|\n/);  //Used to include the name of the sample
    allTextInfo.splice(0,1);                 //Removes all lines after the 3rd line
    allTextInfo.splice(2,2000);              //Removes all lines after the 3rd line
    allTextInfo.pop(10);                     //clears up any remaining lines
    document.getElementById('sampleinfo').value = allTextInfo

    var allTextOwner = csv.split(/\r\n|\n/);  //Used to include the name of the sample
    allTextOwner.splice(0,2);                 //Removes all lines after the 3rd line
    allTextOwner.splice(2,2000);              //Removes all lines after the 3rd line
    allTextOwner.pop(10);                     //clears up any remaining lines
    document.getElementById('owner').value = allTextOwner

    var allTextTemp = csv.split(/\r\n|\n/);  //Used to include the name of the sample
    allTextTemp.splice(0,3);                 //Removes all lines after the 3rd line
    allTextTemp.splice(2,2000);              //Removes all lines after the 3rd line
    allTextTemp.pop(10);                     //clears up any remaining lines
    document.getElementById('temperature').value = allTextTemp


    var allTextPub = csv.split(/\r\n|\n/);  //Used to include the name of the sample
    allTextPub.splice(0,4);                 //Removes all lines after the 3rd line
    allTextPub.splice(2,2000);              //Removes all lines after the 3rd line
    allTextPub.pop(10);                     //clears up any remaining lines
    document.getElementById('publication').value = allTextPub
...
//Draws the box for the axes
    ...
    ctx.lineTo(canvas.width/2+0.5,yaxis); //draws the line
    ctx.stroke();
    ...
    ctx.fillStyle="black";
    ctx.beginPath();
    ctx.moveTo(xaxis0+0.5,yaxis+0.5);
    ctx.lineTo(xaxis+0.5,yaxis+0.5); //draws the line
...
function mossline(){ //This is the new version of draw_sum() and will draw the line. Initially, the values of x are defined by the HTML, but later should change with each new sample
  ...
  var yaxis = 0.7*canvas.height;
  var yaxis0 = 0.1*canvas.height;
  var yaxis0res = 0.05*canvas.height;
  ...
  var yfitsum=[], ysite1=[], ysite2=[], ysite3=[], ysite4=[]; 
  var nuxmax=x[500];

  for (var i = 0; i < nuxmax; i++) {
      //yfitsum.push(((y0-miny)/(maxy-miny)-1)*(Loren_sum(x0[i])));         
      //yfitsum.push(((miny)/(maxy-miny))/400*(Loren_sum(x0[i])));         
      var yintensity = 0.8;
      yfitsum.push(yintensity*(Loren_sum(x0[i])));         
      ysite1.push(yintensity*Loren1(x0[i]));
      ysite2.push(yintensity*Loren2(x0[i]));
      ysite3.push(yintensity*Loren3(x0[i]));
      ysite4.push(yintensity*Loren4(x0[i]));
      
  };

      var LorenziancheckBox = document.getElementById("modelChoice1");
      if (LorenziancheckBox.checked == true){

        for (var i = 0; i < x.length; i++) { //First spectrum
            ctx.strokeStyle="red";
            ctx.beginPath();
            ctx.moveTo(x[i],-ysite1[i]+yaxis0+0.5);
            ctx.lineTo(x[i+1],-ysite1[i+1]+yaxis0+0.5);
            ctx.stroke();
        };
        
        for (var i = 0; i < x.length; i++) { //Second spectrum
            ctx.strokeStyle="blue";
            ctx.beginPath();
            ctx.moveTo(x[i],-ysite2[i]+yaxis0+0.5);
            ctx.lineTo(x[i+1],-ysite2[i+1]+yaxis0+0.5);
            ctx.stroke();
        };
        
        for (var i = 0; i < x.length; i++) {  //Third spectrum
            ctx.strokeStyle="magenta";
            ctx.beginPath();
            ctx.moveTo(x[i],-ysite3[i]+yaxis0+0.5);
            ctx.lineTo(x[i+1],-ysite3[i+1]+yaxis0+0.5);
            ctx.stroke();
        };

        for (var i = 0; i < x.length; i++) {  //Fourth spectrum
            ctx.strokeStyle="green";
            ctx.beginPath();
            ctx.moveTo(x[i],-ysite4[i]+yaxis0+0.5);
            ctx.lineTo(x[i+1],-ysite4[i+1]+yaxis0+0.5);
            ctx.stroke();
        };

        for (var i = 0; i < x.length; i++) {  //Sum of all four spectrum. Goes last
            ctx.strokeStyle="black";
            ctx.beginPath();
            ctx.moveTo(x[i],-yfitsum[i]+yaxis0);
            ctx.lineTo(x[i+1],-yfitsum[i+1]+yaxis0);
            ctx.stroke();
        };
    ...
    //VBF draw
    var vbfysite1=[], vbfysite2=[];


    var VoigtcheckBox = document.getElementById("modelChoice2");
    if (VoigtcheckBox.checked == true){


        for (var i = 0; i < nuxmax; i++) {      
            var yintensity = 8;
            vbfysite1.push(yintensity*Voigt_1(x0[i]));
            vbfysite2.push(yintensity*Voigt_2(x0[i]));
        ...
        for (var i = 0; i < x.length; i++) {  //Sum of all four spectrum. Goes last
            ctx.strokeStyle="red";
            ctx.beginPath();
            ctx.moveTo(x[i],-vbfysite1[i]+yaxis0);
            ctx.lineTo(x[i+1],-vbfysite1[i+1]+yaxis0);
            ctx.stroke();
        };
        ...
        for (var i = 0; i < x.length; i++) {  //Sum of all four spectrum. Goes last
            ctx.strokeStyle="blue";
            ctx.beginPath();
            ctx.moveTo(x[i],-vbfysite2[i]+yaxis0);
            ctx.lineTo(x[i+1],-vbfysite2[i+1]+yaxis0);
            ctx.stroke();
        };
  ...
  //Need to make sure the lines are all black
      ctx.strokeStyle="black";
      ctx.beginPath();
      ctx.stroke();
...
function newGraph(){
  ...
  var y1a=y0[1], y1b=y0[2], y1c=y0[3];
  var y2a=y0[499], y2b=y0[500], y2c=y0[501];
          var bkgd=-(0-y1a-y1b-y1c-y2a-y2b-y2c)/6;

          //In Mössbauer mode, the bkgd is based on the data collected over 500 channels. this does not work for non-Mössbauer data so needs to be adjusted.
          //var bkgd =0;

  //Multiplies the y-range so that it fits into the defined canvas 
  var y = y0.map(function(y0) { return -(((y0-bkgd)/(bkgd-miny))*yaxis)+yaxis0; }); 
  
  var ymodlength=y.length;
  //alert(ymodlength)
  //alert(xlength)

  var yres = y0.map(function(y0) { return -(((y0-bkgd)/(bkgd-miny))*yaxis)+yaxis0; }); 

  //var y = y0.map(function(y0) { return -(((y0-miny)/(bkgd-miny)-1)*yaxis-yaxis0); }); 
  //var yres = y0.map(function(y0) { return -(((y0-miny)/(maxy-miny)-1)*yaxis-yaxis0res); }); 
  ...
  var bkgdnudge = document.getElementById("bkgdnudge").value;
 for (var i = 0; i < x.length; i++) {
      ctx.fillStyle="#FF0000";
      ctx.beginPath();
      ctx.moveTo(x[i],y[i]+2);
      ctx.lineTo(x[i+1],y[i+1]+2);
      ctx.stroke();
  };
  ...
  //var xdiv=0;
  var nuxmin=x[1];
  var nuxmax=x0[x0length]; //Final value in the x-range which will be included in any calculations
  
  for (var i = 0; i < x0.length; i++) {    
      //yfitsum.push(((bkgd)/(bkgd-miny))/400*(Loren_sum(x0[i])));         
      var yintensity = 1;
      //yfitsum+=Loren_sum(x[i]);  
      //yfitsum=Loren_sum(x0[i]);
      yfitsum.push(yintensity*Loren_sum(x0[i]));
      ysite1.push(yintensity*Loren1(x0[i]));
      ysite2.push(yintensity*Loren2(x0[i]));
      ysite3.push(yintensity*Loren3(x0[i]));
  ...
  var Sx = 0, Sy = 0, Syy = 0, yvar = 0;
  yvar=yvar/(x.length-1);

  var yrawlength=y0.length;
  var yrawavg = y.reduce(function(a,b) {
      return ((+a)+(+b))/yrawlength; 
  });

  var yfitlength = yfitsum.length;
  var yfitavg = yfitsum.reduce(function(a,b) {
      return ((+a)+(+b))/yfitlength; 
  });


  var bkgdnudge = document.getElementById("bkgdnudge").value; //be careful about this! Currently this is just changing the maths, not the actual quality of the fit!

  //Draw residuals
  for (var i = 0; i < x.length; i++) {
      //Syy += ((yfitsum[i]-y[i])*(yfitsum[i]-y[i]))/yavg;//dividing by 80 corresponds to the per1 value in Loren functions
      Syy += ((yfitsum[i]+y[i]-bkgdnudge)*(yfitsum[i]+y[i]-bkgdnudge))/yavg;//dividing by 80 corresponds to the per1 value in Loren functions

      //Syy += ((-y[i]-yfitsum[i])*(-y[i]-yfitsum[i]))/yfitsum[i];
  ...
  document.getElementById('chisq').value = Math.round(Syy*100)/100;
...
function residuals(){ //used to calculate the residual line from data and fit. 
  ...
  /////////Start residuals for imported data
  var listx = document.getElementById("outputtxt1").value;
  var listy = document.getElementById("outputtxt2").value;
    var strx = listx.replace(/,\s*$/, " ");   //Remove the last comma from the string
    var arrayx = strx.split(",");  //Divide into array deliminated by comma
    var x0=arrayx;
    var stry = listy.replace(/,\s*$/, "");   //Remove the last comma from the string   
    var arrayy = stry.split(",");  //Divide into array deliminated by comma
    var y0=arrayy;
    var ylength=y0.length;
    var maxy=Math.max.apply(null, y0);
    var miny=Math.min.apply(null, y0);
    ...
    var xrange = ((canvas.width)/(xmax-xmin));  //Determine the multiplicaiton factor for each datapoint:
    //Multiply each datapoint so that it fits within the canvas window:
    x = x0.map(function(x0) { 
    return x0*xrange*1-x00*xrange*1; });
    ...
    var yfitsum=[];
    var nuxmin=x[1];
    var nuxmax=x[500]; //Final value in the x-range which will be included in any calculations
  ...
  /////////Start residuals for reference data
  var ref_listx = document.getElementById("outputtxt1b").value;
  var ref_listy = document.getElementById("outputtxt2b").value;
   var ref_strx = ref_listx.replace(/,\s*$/, " ");   //Remove the last comma from the string
    var ref_arrayx = ref_strx.split(",");  //Divide into array deliminated by comma
    var ref_x0=ref_arrayx;
    var ref_stry = ref_listy.replace(/,\s*$/, "");   //Remove the last comma from the string   
    var ref_arrayy = ref_stry.split(",");  //Divide into array deliminated by comma
    var ref_y0=ref_arrayy;
    var ref_ylength=ref_y0.length;
    var ref_maxy=Math.max.apply(null, ref_y0);
    var ref_miny=Math.min.apply(null, ref_y0);
    var ref_yrange=canvas.height;

    //Define the background
    var ref_y1a=ref_y0[1], ref_y1b=ref_y0[2], ref_y1c=ref_y0[3];
    var ref_y2a=ref_y0[499], ref_y2b=ref_y0[500], ref_y2c=ref_y0[501];
          var ref_bkgd=-(0-ref_y1a-ref_y1b-ref_y1c-ref_y2a-ref_y2b-ref_y2c)/6;

    //Multiplies the y-range so that it fits into the defined canvas 
    var ref_y = ref_y0.map(function(ref_y0) { return -(((ref_y0-ref_bkgd)/(ref_bkgd-ref_miny))*yaxis)+yaxis0; }); 
    

    var checkBox4 = document.getElementById("tick4");
    var checkBox5 = document.getElementById("tick5");
    var checkBox6 = document.getElementById("tick6");


    //Draw residuals for reference data
    if (checkBox4.checked == true){
          for (var i = 0; i < x.length; i++) {
              ctx.strokeStyle="red";
              ctx.beginPath();
              ctx.moveTo(x[i]-1,0.5*((ref_y[i])+(yfitsum[i]))+canvas.height/2+0.5);
              ctx.lineTo(x[i+1]-1,0.5*((ref_y[i+1])+(yfitsum[i+1]))+canvas.height/2+0.5);
              ctx.stroke();
          };
    }

    //Draw residuals for imported data
    if (checkBox5.checked == true){
      for (var i = 0; i < x.length; i++) {
          ctx.strokeStyle="black";
          ctx.beginPath();
          ctx.moveTo(x[i]-1,0.5*((y[i])+(yfitsum[i]))+canvas.height/2+0.5);
          ctx.lineTo(x[i+1]-1,0.5*((y[i+1])+(yfitsum[i+1]))+canvas.height/2+0.5);
          ctx.stroke();
      };
    }

    //Draw residuals for imported vs reference data
    if (checkBox6.checked == true){
      for (var i = 0; i < x.length; i++) {
          ctx.strokeStyle="blue";
          ctx.beginPath();
          ctx.moveTo(x[i]-1,((ref_y[i])-(y[i]))+canvas.height/2+0.5);
          ctx.lineTo(x[i+1]-1,((ref_y[i+1])-(y[i+1]))+canvas.height/2+0.5);
          ctx.stroke();
      };
    }
...
/*
    ...
    //Draw residuals for reference data-imported data
    for (var i = 0; i < x.length; i++) {
        ctx.strokeStyle="blue";
        ctx.beginPath();
        ctx.moveTo(x[i]-1,0.5*((ref_y[i])+(y[i]))+canvas.height/2+0.5);
        ctx.lineTo(x[i+1]-1,0.5*((ref_y[i+1])+(y[i+1]))+canvas.height/2+0.5);
        ctx.stroke();
    };
*/


    //Draw middle line for residuals
    ctx.strokeStyle="black";
    ctx.beginPath();
    ctx.moveTo(0,canvas.height/2+0.5);
    ctx.lineTo(canvas.width,canvas.height/2+0.5); //draws the line
    ctx.stroke();

    //Label for residuals
    ctx.font="10pt Arial";
    ctx.fillText("Residual",10,canvas.height/3);
...
for (var i = 0; i < x.length; i++) {
      ctx.fillStyle="#FF0000";
      ctx.beginPath();
      ctx.moveTo(x[i],y[i]+1.0);
      ctx.lineTo(x[i+1],y[i+1]+1.0);
      ctx.stroke();
  };
  ...
  /*for (var i = 0; i < x.length; i++) {
      ctx.fillStyle="#FF0000";
      ctx.beginPath();
      ctx.moveTo(x[i],-yfitsum[i]+2);
      ctx.lineTo(x[i+1],-yfitsum[i+1]+2);
      ctx.stroke();
  };*/
  ...
  var y1a=y0[1], y1b=y0[2], y1c=y0[2];
  var y2a=y0[499], y2b=y0[500], y2c=y0[501];
          var bkgd=-(0-y1a-y1b-y1c-y2a-y2b-y2c)/6;
...
function openModel(evt, cityName) {
    ...
    // Get all elements with class="tablinks" and remove the class "active"
    tablinks = document.getElementsByClassName("minitablinks");
    for (i = 0; i < tablinks.length; i++) {
        tablinks[i].className = tablinks[i].className.replace(" active", "");
    }
