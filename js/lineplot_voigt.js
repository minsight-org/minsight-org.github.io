...
function xmcd(x,y){
		...
		var canvasxmcd = document.getElementById("myXMCDCanvas");
...
function Voigt_1(x) {
    ...
    var eps = document.getElementById("qshift_1").value;
    var bhf = document.getElementById("hyperfinefield_1").value;
    var sigma = document.getElementById("sigma_1").value;
    var ratio1 = document.getElementById("ratio_1").value;
    ...
    var vphisum = vphi1+vphi2+vphi3+vphi4+vphi5+vphi6;
    //var vphisum = vphi1;
...
function Voigt_2(x) {
    ...
    var eps = document.getElementById("qshift_2").value;
    var bhf = document.getElementById("hyperfinefield_2").value;
    var sigma = document.getElementById("sigma_2").value;
    var ratio2 = document.getElementById("ratio_2").value;
	...
	function draw_sum() {
      ...
      MBplot(ctx,axes,Voigt_1,"black",3);
      MBplot(ctx,axes,Voigt_2,"red",3);
...
function samplespectra(){
        ...
        var csv = document.getElementById('dataoutput');
          ...
          //var csv = e.target.result;
            ...
            xhttp.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                    csv.innerText=this.responseText;        
                    //csv = e.target.result;
                    //processData(csv);
            ...
            xhttp.open("GET", e.target.value, true);
            xhttp.send();
            
        });

            document.getElementById('outputtxt3').value = csv.innerText;
            //processData(csv)
