...
/* Image loader **********************************/
      ...
      var sources = {
              img1: 'DSC00335.jpg',
              img2: 'https://www.html5canvastutorials.com/demos/assets/yoda.jpg',
              img3: 'sampleprep.png'
              };
      ...
      function load2(){
        loadImages(sources, function(images) {
        context.drawImage(images.img2, 100, 30, 200, 137);
      });};  

      function load3(){
        loadImages(sources, function(images) {
        context.drawImage(images.img3, 100, 30, 200, 137);
      });};
      ...
      function submitimg() {
        ...
        var img=x;
        loadImages(sources, function(images) {
        context.drawImage(images.img, 100, 30, 200, 137);
      });};
/*************************************************/
...
function processlistData() {
    ...
    var deliminat5 = document.getElementById("delChoice4");
